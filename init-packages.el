...
(defvar apm-packages '(ac-slime ack-and-a-half ace-jump-mode
   ...
   gitconfig-mode gitignore-mode helm ido-ubiquitous js2-mode
   latex-extra magit multiple-cursors php-mode rainbow-mode
   scratch shell-pop smartparens smex smooth-scroll surround
