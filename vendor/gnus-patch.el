...
(set-face-attribute 'ft-gnus-three-dashes nil :inherit 'default)
(make-face 'ft-gnus-scissors)
(set-face-attribute 'ft-gnus-scissors nil :inherit 'default)
(make-face 'ft-gnus-diff-index)
(set-face-attribute 'ft-gnus-diff-index nil :inherit 'default)
...
(set-face-attribute 'ft-gnus-diff-equals nil :inherit 'default)
(make-face 'ft-gnus-commit-message)
(set-face-attribute 'ft-gnus-commit-message nil :inherit 'default)
(make-face 'ft-gnus-diff-stat-file)
(set-face-attribute 'ft-gnus-diff-stat-file nil :inherit 'default)
(make-face 'ft-gnus-diff-stat-bar)
(set-face-attribute 'ft-gnus-diff-stat-bar nil :inherit 'default)
(make-face 'ft-gnus-diff-stat-num)
(set-face-attribute 'ft-gnus-diff-stat-num nil :inherit 'default)
(make-face 'ft-gnus-diff-misc)
(set-face-attribute 'ft-gnus-diff-misc nil :inherit 'default)
...
(make-face 'ft-gnus-comment1)
(set-face-attribute 'ft-gnus-comment1 nil :inherit 'gnus-cite-1)
(make-face 'ft-gnus-comment2)
(set-face-attribute 'ft-gnus-comment2 nil :inherit 'gnus-cite-2)
(make-face 'ft-gnus-comment3)
(set-face-attribute 'ft-gnus-comment3 nil :inherit 'gnus-cite-3)
(make-face 'ft-gnus-comment4)
(set-face-attribute 'ft-gnus-comment4 nil :inherit 'gnus-cite-4)
...
(defun ft-gnus-reply-line-p (line)
  "Returns face if `line' looks like a reply to previous message; `nil' otherwise."
  (cond
   ((string-match "^> *> *> *> " line) 'ft-gnus-comment4)
   ((string-match "^> *> *> "    line) 'ft-gnus-comment3)
   ((string-match "^> *> "       line) 'ft-gnus-comment2)
   ((string-match "^> "          line) 'ft-gnus-comment1)
   (t nil)))

;; Patch mail detection
(defvar ft-gnus-article-patch-conditions '("diff" "patch")
               ...
               ((eq state 'commit-message)
                (cond
                 ...
                 ((ft-gnus-atp-looks-like-diff line)
                  (setq do-not-move t)
                  'unified-diff)
                 ((ft-gnus-reply-line-p line)
                  (ft-gnus-colour-line (ft-gnus-reply-line-p line))
                  'commit-message)
                 (t
