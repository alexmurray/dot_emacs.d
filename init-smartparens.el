...
;; keybindings - these are mostly the default smartparens ones taken
;; from
...
;; modified from default smartparens bindings which use M instead of S
;; (but this conflicts with workspace switching in Ubuntu so use shift
;; instead)
